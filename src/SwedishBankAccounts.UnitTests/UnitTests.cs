...
public abstract class UnitTests
{
    ...
    public static IEnumerable<object[]> ValidAccountNumbers =>
        new List<object[]>
        {
            ...
            new object[] { "9683,143 579 155", "BlueStep Finans", InitOptions.Strict },
            ...
            new object[] { "9597 984 216 868", "Erik Penser", InitOptions.Strict },
            ...
            new object[] { "9630, 6541128", "Lån & Spar Bank Sverige", InitOptions.Strict },
            ...
            new object[] { "9252 132 2148", "SBAB", InitOptions.Strict },
