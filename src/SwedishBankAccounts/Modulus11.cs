...
/// <summary>
/// Handles validation and calculation of check digit according to the modulus-11 method
/// </summary>
public static class Modulus11
{
    /// <summary>
    /// Validates the given number according to the modulus-11 method
    /// </summary>
    /// <param name="number">The number to perform the validation upon</param>
    /// <returns>True if the number is valid according to the modulus-11 method, otherwise false</returns>
    ...
    /// <summary>
    /// Calculates the check digit according to the modulus-11 method
    /// </summary>
