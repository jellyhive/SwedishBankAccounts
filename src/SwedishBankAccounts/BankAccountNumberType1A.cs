...
/// <summary>
/// Bank account number type 1A - Used for 4+7 digit account numbers with modulus-11 validation
/// </summary>
public record BankAccountNumberType1A : BankAccountNumberType
{
    /// <summary>
    /// Validates the account number using modulus-11 algorithm on the last 3 digits of sorting code plus padded account number
    /// </summary>
