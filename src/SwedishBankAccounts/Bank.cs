...
public record Bank(string Name, Range[] SortingCodeRange, BankAccountNumberType BankAccountNumberType, string? Bic = null)
{
    /// <summary>
    ...
    public static IEnumerable<Bank> Banks
    {
        get
        {
            return new[]
            {
                ...
                new Bank("Avanza Bank", new[] { new Range(9550, 9569) }, new BankAccountNumberType1B(), "AVANSESX"),
                ...
                new Bank("Danske Bank", new[] { new Range(1200, 1399), new Range(2400, 2499) }, new BankAccountNumberType1A(), "DABASESX"),
                new Bank("DNB Bank", new[]
                {
                    new Range(9190, 9199),
                    new Range(9260, 9269)
                }, new BankAccountNumberType1B(), "DNBASESS"),
                ...
                new Bank("Forex Bank", new[] { new Range(9400, 9449) }, new BankAccountNumberType1B(), "FORXSESA"),
                new Bank("ICA Banken", new[] { new Range(9270, 9279) }, new BankAccountNumberType1A(), "IBCASES1"),
                ...
                new Bank("Landshypotek", new[] { new Range(9390, 9399) }, new BankAccountNumberType1B(), "LAHYSESS"),
                ...
                new Bank("Länsförsäkringar Bank", new[] { new Range(3400, 3409), new Range(9060, 9069) }, new BankAccountNumberType1A(), "ELLFSESS"),
                new Bank("Länsförsäkringar Bank", new[] { new Range(9020, 9029) }, new BankAccountNumberType1B(), "ELLFSESS"),
                new Bank("Marginalen Bank", new[] { new Range(9230, 9239) }, new BankAccountNumberType1A()),
                ...
                new Bank("Nordea", new[]
                {
                    ...
                    new Range(3410, 3781),
                    new Range(3783, 3999),
                }, new BankAccountNumberType1A(), "NDEASESS"),
                new Bank("Nordea", new[] { new Range(4000, 4999) }, new BankAccountNumberType1B(), "NDEASESS"),
                new Bank("Nordnet Bank", new[] { new Range(9100, 9109) }, new BankAccountNumberType1B(), "NNSESE22"),
                new Bank("Northmill Bank", new[] { new Range(9750, 9759) }, new BankAccountNumberType1B()),
                new Bank("Resurs Bank", new[] { new Range(9280, 9289) }, new BankAccountNumberType1A(), "RESUSE21"),
                ...
                new Bank("SBAB", new[] { new Range(9250, 9259) }, new BankAccountNumberType1A(), "SBAVSESS"),
                new Bank("SEB", new[]
                {
                    new Range(5000, 5999),
                    new Range(9120, 9124),
                    new Range(9130, 9149),
                }, new BankAccountNumberType1A(), "ESSESESS"),
                new Bank("Skandiabanken", new[] { new Range(9150, 9169) }, new BankAccountNumberType1B(), "SKIASESS"),
                new Bank("Svea Bank", new[] { new Range(9660, 9669) }, new BankAccountNumberType1B()),
                new Bank("Swedbank", new[] { new Range(7000, 7999) }, new BankAccountNumberType1A(), "SWEDSESS"),
                new Bank("Sveriges Riksbank", new[] { new Range(1000, 1099) }, new BankAccountNumberType1B()),

                new Bank("Danske Bank", new[] { new Range(9180, 9189) }, new BankAccountNumberType2A(), "DABASESX"),
                new Bank("Handelsbanken", new[] { new Range(6000, 6999) }, new BankAccountNumberType2B(), "HANDSESS"),
                new Bank("Nordea", new[]
                {
                    new Range(3300, 3300),
                    new Range(3782, 3782)
                }, new BankAccountNumberType2A(), "NDEASESS"),
                new Bank("Nordea Plusgirot", new[]
                {
                    new Range(9500, 9549),
                    new Range(9960, 9969)
                }, new BankAccountNumberType2C(), "NDEASESS"),
                ...
                new Bank("Swedbank", new[]
                {
                    ...
                    new Range(8000, 8999)
                }, new BankAccountNumberType2C(), "SWEDSESS"), // Allowing 11 here in case clearingnumber is sent as the first four instead of the first five
                new Bank("Swedbank", new[] { new Range(9300, 9349) }, new BankAccountNumberType2A(), "SWEDSESS"),
                new Bank("Ålandsbanken", new[] { new Range(2300, 2399) }, new BankAccountNumberType2A(), "AABASESS")
            };
        }
    }
